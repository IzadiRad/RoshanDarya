...
<body style="direction: rtl;">
    <header class=" top-0 bg-white z-50 shadow-lg">
        ...
        <nav class="flex justify-center items-center space-x-8 mx-auto relative ">
            ...
            <div id="mobile-menu" class="hidden">
                <a href="#" id="home-link-mob"><i class="fas fa-home"></i> خانه</a>
                <hr />
                <a id="services-linkss" class="menu-item">
                    <i class="fas fa-cog" id="services-link-mob"></i> خدمات
                    <span class="submenu-icon">&#9662;</span>
                </a>
                <div id="services-submenu" class="submenu hidden">
                    <a href="#" id="maritime-link-mob"><i class="fas fa-home"></i> حمل و نقل دریایی</a>
                    <a href="#" id="air-freight-link-mob"><i class="fas fa-home"></i> حمل و نقل هوایی</a>
                    <a href="#" id="ground-transport-link-mob"><i class="fas fa-home"></i> حمل و نقل زمینی</a>
                    <a href="#" id="services-maps-link-mob"><i class="fas fa-home"></i> نقشه‌های خدمات</a>
                </div>
                ...
                <a href="#" id="eqc-linkss" class="menu-item">
                    <i class="fas fa-cog"></i> شرایط حمل و نقل +
                    <span class="submenu-icon">&#9662;</span>
                </a>
                <div id="eqc-submenu" class="submenu hidden">
                    <a href="#" id="incoterms-link-mob"><i class="fas fa-home"></i> شرایط اینکوترمز</a>
                    <a href="#" id="cargo-link-mob"><i class="fas fa-box"></i> کالا</a>
                </div>
                <hr />
                <a href="#" id="about-us-link-mob"><i class="fas fa-info-circle"></i> درباره ما</a>
                <hr />
                <a href="#contact-section" id="contact-us-link-mob"><i class="fas fa-envelope"></i> تماس با ما</a>

            </div>


            <!-- منوی سمت چپ لوگو -->
            <menu class="flex items-center flex-row w-full justify-center " style="margin: 0;">
                <nav id="menu" class="hidden md:flex space-x-4 mymenu">
                    <a href="#" class="nav-link custome-size-menu custome-menu-item text-white" id="home-link">خانه</a>
                    <div class="relative">
                        <a href="#" id="desktop-services"
                        ...
                        <div id="services-dropdown" class="absolute hidden bg-white shadow-lg mt-2 w-48 substack">
                            <a href="#" class="block px-4 py-2 text-gray-800 hover:bg-gray-200 text-white"
                                id="maritime-link">حمل و نقل دریایی</a>
                            <a href="#" class="block px-4 py-2 text-gray-800 hover:bg-gray-200 text-white"
                                id="ground-transport-link">حمل و نقل هوایی</a>
                            <a href="#" class="block px-4 py-2 text-gray-800 hover:bg-gray-200  text-white"
                                id="air-freight-link">حمل و نقل زمینی</a>
                            <a href="#" class="block px-4 py-2 text-gray-800 hover:bg-gray-200 text-white"
                                id="services-maps-link">نقشه‌های خدمات</a>
                        </div>
                    </div>

                    <a href="#" class="nav-link custome-size-menu custome-menu-item text-white"
                        id="request-quote-link">درخواست قیمت</a>

                </nav>

                <!-- لوگو وسط منو -->
                <div class="relative flex justify-center items-center mt-4 mb-4 mx-5 ">
                    <div id="logo-butt"
                        class="absolute w-44 h-28 rounded-full z-10 shadow-[0_8px_16px_rgba(0,0,255,0.5)] -top-7 mobwhite ">
                    </div>
                    <img src="../Images/Icon/roshan-new-en.png" alt="roshandarya"
                        class="relative w-36 h-auto z-10 top-6">
                </div>

                <!-- منو سمت راست لوگو -->
                <nav class="hidden md:flex space-x-4 mymenu">

                    <div class="relative z-10">
                        <a href="#" id="desktop-eqc"
                        ...
                        <div id="eqc-dropdown" class="absolute hidden bg-white shadow-lg mt-2 w-48 right-0 substack">
                            <a href=" #" class="block px-4 py-2 text-gray-800 hover:bg-gray-200"
                                id="incoterms-link">شرایط
                                اینکوترمز</a>
                            <a href="#" class="block px-4 py-2 text-gray-800 hover:bg-gray-200" id="cargo-link">کالا</a>
                        </div>
                    </div>
                    <a href="#" class="nav-link custome-size-menu custome-menu-item text-white"
                        id="about-us-link">درباره
                        ما</a>
                    <a href="#sss" class="nav-link custome-size-menu custome-menu-item text-white"
                        id="contact-us-link">تماس
                        با ما</a>
                    <a href="../index.php" class="nav-link custome-size-menu custome-menu-item language-toggle">
                        <img src="../Images/usa-flag-icon.svg" alt="Iran Flag" id="flag-icon" class="w-6 h-6">
                    </a>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
                ...
                <div class="bg-white p-6 shadow-lg rounded-lg transition duration-300 transform hover:scale-105 hover:bg-blue-600 group flex flex-col items-center secCard"
                    ...
                    <div class="text-center">
                        ...
                        <div>
                            <div class="item-description group-hover:text-white">بهینه‌سازی فرآیندهای حمل و نقل</div>
                            <h3
                                class="text-xl font-semibold mb-2 text-[var(--primary-navy-blue)]-800 group-hover:text-white">
                                راهکارهای لجستیکی</h3>
                        </div>
                ...
                <div data-aos="fade-right"
                    ...
                    <div class="text-center">
                        ...
                        <div>
                            <!-- توضیحات -->
                            <div
                                class="item-description text-sm leading-6 text-gray-600 group-hover:text-white font-vazir">
                                بهینه‌سازی فرآیندهای حمل و نقل
                            </div>
                            <!-- عنوان -->
                            <h3
                                class="text-lg font-bold mb-2 text-[var(--primary-navy-blue)] group-hover:text-white leading-7 font-vazir">
                                راهکارهای لجستیکی
                            </h3>
                        </div>
                ...
                <div data-aos="fade-left"
                    ...
                    <div class="text-center">
                        ...
                        <div>
                            <div class="item-description group-hover:text-white">راه‌حلی ساده برای تجارت بین‌المللی
                            </div>
                            <h3
                                class="text-xl font-semibold mb-2 text-[var(--primary-navy-blue)]-800 group-hover:text-white">
                ...
                <div data-aos="fade-left"
                    ...
                    <div class="text-center">
                        ...
                        <div>
                            <div class="item-description group-hover:text-white">رویکردی کارآمد برای مسیرهای پیچیده
                            </div>
                            <h3
                                class="text-xl font-semibold mb-2 text-[var(--primary-navy-blue)]-800 group-hover:text-white">
                                ترانزیت</h3>
                        ...
                        <div>
                            <div class="mb-4 border-l-4 pl-4" style="border-color: #2563EB;">
                                <h3 class="text-2xl font-semibold uppercase mb-4 tracking-widest"
                                    style="font-family: var(--font-poppins);color: #2563EB;">درباره ما</h3>
                            </div>
                            ...
                            <p class="text-secondary-grayish-blue mb-4" style="font-family: var(--font-noto-sans);">
                                ...
                                شما با دقت و کارایی جابجا شود
                            </p>
                            <p class="text-secondary-grayish-blue mb-4" style="font-family: var(--font-noto-sans);">
                                ما در حمل‌ونقل دریایی، زمینی و هوایی تخصص داریم و راهکارهای متناسب با نیازهای شما ارائه
                                می‌دهیم، پشتیبانی شده با شبکه‌ای قوی و فناوری پیشرفته.
                            </p>
                            <p class="text-secondary-grayish-blue mb-6" style="font-family: var(--font-noto-sans);">
                                ماموریت ما: "بار شما در دستان امن ماست." هدف ما فراتر رفتن از انتظارات شما با خدمات
    ...
    <section class="flex flex-col md:flex-row container mx-auto max-w-screen-lg mt-10 p-4 service-section"
                ...
                <li class="service-tab cursor-pointer h-full group" data-content="service1">
                    <div
                        ...
                        <div class="flex items-center w-full flex justify-around">
                            ...
                            <span
                                class="ml-4 text-white group-hover:text-blue-500 transition-colors duration-300 text-center">راهکارهای
                                لجستیک متناسب</span>
                        </div>
                    </div>
                </li>
                ...
                <li class="service-tab cursor-pointer h-full group" data-content="service2">
                    <div
                        ...
                        <div class="flex items-center w-full flex justify-around">
                            ...
                            <span
                                class="ml-4 text-white group-hover:text-blue-500 transition-colors duration-300 text-center">پیگیری
                                بار به‌صورت لحظه‌ای</span>
                        </div>
                    </div>
                </li>
                ...
                <li class="service-tab cursor-pointer h-full group" data-content="service3">
                    <div
                        ...
                        <div class="flex items-center w-full flex justify-around">
                            ...
                            <span
                                class="ml-4 text-white group-hover:text-blue-500 transition-colors duration-300 text-center">پشتیبانی
                                مشتریان</span>
                        </div>
                    </div>
                </li>
                    ...
                    <div
                        ...
                        <div class="flex items-center w-full flex justify-around ">
                            <svg version="1.1" id="Layer_1"
                                ...
                                class="ml-4 text-white group-hover:text-blue-500 transition-colors duration-300 text-center">راهکارهای
                                لجستیک دوست‌دار محیط زیست</span>
                        </div>
                    </div>
                </li>
            </ul>
        ...
        <div class="w-full md:w-3/4 bg-white p-6 h-full">
            ...
            <div id="service1" class="service-content hidden text-center">
                ...
                <h2 class="text-2xl font-bold mb-4">راهکارهای لجستیک متناسب</h2>
                <p>ما درک می‌کنیم که هر کسب‌وکاری منحصربه‌فرد است. راهکارهای لجستیک ما به گونه‌ای طراحی شده‌اند که
                    نیازهای خاص شما را با بالاترین سطح بهره‌وری و صرفه‌جویی برآورده کنند.</p>
            ...
            <div id="service2" class="service-content hidden">
                ...
                <br />
                <h2 class="text-2xl font-bold mb-4 text-center">پیگیری بار به‌صورت لحظه‌ای</h2>
                <p>با سیستم پیگیری لحظه‌ای ما همیشه در جریان وضعیت بار خود باشید. از لحظه حرکت تا تحویل، با شفافیت کامل
                    اطلاعات را دریافت کنید.</p>
            ...
            <div id="service3" class="service-content hidden text-center">
                ...
                <h2 class="text-2xl font-bold mb-4">پشتیبانی مشتریان ۲۴/۷</h2>
                <p>تیم پشتیبانی ما به صورت ۲۴ ساعته و در ۷ روز هفته آماده پاسخگویی به سوالات شماست. چه برای رزرو و چه
                    برای سوالات مرتبط با حمل‌ونقل، همواره در کنارتان هستیم.</p>
            ...
            <div id="service4" class="service-content hidden text-center">
                ...
                <h2 class="text-2xl font-bold mb-4">راهکارهای لجستیک دوست‌دار محیط زیست</h2>
                <p>ما به تعهدات خود نسبت به محیط زیست پایبندیم. راهکارهای لجستیک دوست‌دار محیط زیست ما شامل بهینه‌سازی
                    مسیرها و استفاده از روش‌های حمل‌ونقل سبز است.</p>
    ...
    <section id="counter-section" class="py-10 bg-primary-light-gray">
        <div class="container mx-auto px-4 text-center">
            <h2 class="text-4xl font-bold text-primary-navy-blue mb-6">دستاوردهای ما</h2>
            <p class="text-lg mb-12">ما به آمار خود افتخار می‌کنیم!</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="counter-item bg-white rounded-lg shadow-md p-6">
                    ...
                    <p class="text-xl text-secondary-grayish-blue">مشتریان راضی</p>
                </div>
                ...
                <div class="counter-item bg-white rounded-lg shadow-md p-6">
                    ...
                    <p class="text-xl text-secondary-grayish-blue">پروژه‌های تکمیل‌شده</p>
                </div>
                ...
                <div class="counter-item bg-white rounded-lg shadow-md p-6">
                    ...
                    <p class="text-xl text-secondary-grayish-blue">شرکت‌های همکار</p>
                </div>
                ...
                <div class="counter-item bg-white rounded-lg shadow-md p-6">
                    ...
                    <p class="text-xl text-secondary-grayish-blue">سال‌ها تجربه</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="overflow-x-hidden">
            <div id="blogScroll" class="blogScroll flex space-x-4 cursor-grab overflow-x-auto"
                ...
                <div
                    ...
                    <div class="blog-img">
                        <a class="blog-link">
                            <img class="w-full h-auto pointer-events-none" src="https://via.placeholder.com/350"
                                alt="Blog Image 1"> <!-- غیرفعال کردن کلیک -->
                        </a>
                    </div>
                    <div class="p-4">
                ...
                <div
                    ...
                    <div class="blog-img">
                        <a class="blog-link">
                            <img class="w-full h-auto pointer-events-none" src="https://via.placeholder.com/350"
                                alt="Blog Image 2"> <!-- غیرفعال کردن کلیک -->
                        </a>
                    </div>
                    <div class="p-4">
                ...
                <div
                    ...
                    <div class="blog-img">
                        <a class="blog-link">
                            <img class="w-full h-auto pointer-events-none" src="https://via.placeholder.com/350"
                                alt="Blog Image 3"> <!-- غیرفعال کردن کلیک -->
                        </a>
                    </div>
                    <div class="p-4">
                ...
                <div
                    ...
                    <div class="blog-img">
                        <a class="blog-link">
                            <img class="w-full h-auto pointer-events-none" src="https://via.placeholder.com/350"
                                alt="Blog Image 4"> <!-- غیرفعال کردن کلیک -->
                        </a>
                    </div>
                    <div class="p-4">
    ...
    <section id="rate-inquiry" class="bg-primary-light-gray py-6">
        <div class="container mx-auto px-4 flex flex-row flex-wrap gap-4 justify-center">
            ...
            <input type="text" placeholder="فرودگاه مقصد" class="input-field w-full md:w-1/3 lg:w-1/5">
            <input type="text" placeholder="شماره تلفن" class="input-field w-full md:w-1/3 lg:w-1/5">
            <input type="email" placeholder="ایمیل" class="input-field w-full md:w-1/3 lg:w-1/5">
    ...
    <section id="faq-section" class="py-10 bg-primary-light-gray text-primary-navy-blue">
        <div class="container mx-auto px-4 text-center mb-8 ">
            <h2 class="text-4xl font-bold mb-4">سوالات متداول</h2>
            <p class="text-lg mb-8">پاسخ به پرسش‌های رایج شما</p>
        </div>
        <div class="container mx-auto px-4">
            ...
            <div class="faq-item border-b border-secondary-grayish-blue py-4">
                <button
                    ...
                    <span>چه نوع کالاهایی را می‌توانید جابجا کنید؟</span>
                ...
                <div class="faq-answer hidden mt-2 text-secondary-grayish-blue p-3 bg-white rounded-md shadow-inner">
                    <p>ما انواع مختلف کالا از جمله فله‌ای، یخچالی، خطرناک و بارهای حجیم را جابجا می‌کنیم</p>
                </div>
            </div>
            ...
            <div class="faq-item border-b border-secondary-grayish-blue py-4">
                <button
                    class="w-full text-left flex justify-between items-center font-semibold text-xl p-3 bg-primary-turquoise rounded-md shadow-md hover:bg-primary-Blue-light transition-all duration-300"
                    onclick="toggleFAQ(this)">
                    <span>آیا خدمات حمل‌ونقل داخلی و بین‌المللی ارائه می‌دهید؟</span>
                    <i class="fas fa-chevron-down text-secondary-dark-blue transition-transform duration-300"></i>
                </button>
                <div class="faq-answer hidden mt-2 text-secondary-grayish-blue p-3 bg-white rounded-md shadow-inner">
                    <p>بله، ما خدمات حمل‌ونقل داخلی و بین‌المللی را بر اساس نیازهای شما ارائه می‌دهیم.</p>
                </div>
            </div>
            ...
            <div class="faq-item border-b border-secondary-grayish-blue py-4">
                <button
                    class="w-full text-left flex justify-between items-center font-semibold text-xl p-3 bg-primary-turquoise rounded-md shadow-md hover:bg-primary-Blue-light transition-all duration-300"
                    onclick="toggleFAQ(this)">
                    <span>چگونه می‌توانم بار خود را پیگیری کنم؟</span>
                    <i class="fas fa-chevron-down text-secondary-dark-blue transition-transform duration-300"></i>
                </button>
                <div class="faq-answer hidden mt-2 text-secondary-grayish-blue p-3 bg-white rounded-md shadow-inner">
                    <p>شما می‌توانید از طریق سیستم پیگیری آنلاین ما با استفاده از شماره پیگیری، وضعیت بار خود را مشاهده
                        کنید.
                    </p>
                </div>
            </div>
            ...
            <div class="faq-item border-b border-secondary-grayish-blue py-4">
                <button
                    class="w-full text-left flex justify-between items-center font-semibold text-xl p-3 bg-primary-turquoise rounded-md shadow-md hover:bg-primary-Blue-light transition-all duration-300"
                    onclick="toggleFAQ(this)">
                    <span>چه روش‌های پرداختی در دسترس هستند؟</span>
                    <i class="fas fa-chevron-down text-secondary-dark-blue transition-transform duration-300"></i>
                </button>
                <div class="faq-answer hidden mt-2 text-secondary-grayish-blue p-3 bg-white rounded-md shadow-inner">
                    <p>ما روش‌های پرداخت مختلفی از جمله انتقال بانکی، کارت اعتباری و پرداخت آنلاین را می‌پذیریم.
                    </p>
                </div>
            </div>
            ...
            <div class="faq-item border-b border-secondary-grayish-blue py-4">
                <button
                    class="w-full text-left flex justify-between items-center font-semibold text-xl p-3 bg-primary-turquoise rounded-md shadow-md hover:bg-primary-Blue-light transition-all duration-300"
                    onclick="toggleFAQ(this)">
                    <span>چگونه ایمنی کالاهای من را تضمین می‌کنید؟</span>
                    <i class="fas fa-chevron-down text-secondary-dark-blue transition-transform duration-300"></i>
                </button>
                <div class="faq-answer hidden mt-2 text-secondary-grayish-blue p-3 bg-white rounded-md shadow-inner">
                    <p>ما از استانداردهای ایمنی و مقررات صنعتی برای حفاظت از کالاهای شما در طول حمل‌ونقل پیروی می‌کنیم.
                    </p>
                </div>
            </div>
    ...
    <br />
    <br />
    <section id="contact-section" class="py-10 bg-white text-primary-navy-blue">
        <div class="container mx-auto px-4 text-center mb-8">
            <h2 class="text-4xl font-bold mb-4">با ما در ارتباط باشید</h2>
            <p class="text-lg">خوشحال می‌شویم نظرات شما را بشنویم!</p>
        </div>
            ...
            <form class="bg-light rounded-lg p-6 shadow-md">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="form-group">
                        ...
                        <input type="text" id="name" required placeholder="نام شما">
                    </div>

                    <div class="form-group">
                        <label for="email">ایمیل</label>
                        <input type="email" id="email" required placeholder="ایمیل شما">
                    </div>
                </div>

                <div class="form-group mt-4">
                    <label for="message">پیام</label>
                    <textarea id="message" rows="5" required placeholder="پیام شما"></textarea>
                </div>

                <button type="submit" class="mt-4">ارسال پیام</button>
            </form>
        </div>
    </section>
    ...
    <section id="sec-6" class="bg-primary-navy-blue text-white py-10">
        <div class="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="about">
                <h1>درباره شرکت</h1>
                <h2>روشن دریا</h2>
                <p>راهکارهای جامع حمل‌ونقل و لجستیک</p>
                <p>ما در ارائه خدمات حمل‌ونقل و لجستیک جهانی تخصص داریم و متعهد به کیفیت و رضایت مشتریان هستیم.</p>
                <h2>موقعیت ما</h2>
                <iframe loading="lazy"
            ...
            <div class="posts">
                <h1 class="text-xl font-bold mb-4">آخرین مطالب</h1>
                <a href="#" class="block mb-2">
                    <span class="font-semibold">۲۰<br>مرداد</span> نکات مهم برای حمل‌ونقل مؤثر
                </a>
                <a href="#" class="block mb-2">
                    <span class="font-semibold">۱۵<br>مرداد</span> چگونه تحویل سریع را تضمین می‌کنیم
                </a>
                <a href="#" class="block mb-2">
                    <span class="font-semibold">۱۰<br>مرداد</span> آینده حمل‌ونقل دریایی
                </a>
                <a href="#" class="block mb-2">
                    <span class="font-semibold">۵<br>مرداد</span> داستان‌های موفقیت مشتریان
                </a>
                <a href="#" class="block mb-2">
                    <span class="font-semibold">۱<br>مرداد</span> پیمایش مسیرهای تجاری جدید
                </a>
            </div>
            ...
            <div class="contact">
                <h1>تماس با ما</h1>
                <p>واحد ۲ و ۴، پلاک ۲۳۵، بعد از تقاطع سرافراز، خیابان مطهری، تهران، ایران</p>
    ...
    <!-- quoteModal-->
    <div id="quoteModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
        <div class="bg-white p-6 rounded-lg w-11/12 md:w-1/2 lg:w-1/3 " style="width: auto;">
            <span id="closeModal" class="text-right text-2xl cursor-pointer">&times;</span>
            <!-- محتوای فرم درخواست نرخ -->
